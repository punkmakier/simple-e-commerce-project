<?php
    ...
    require_once '../class/displayCancelledOrder.php';
    ...
    <div class="container">
        ...
        <div class="row mt-3">
            ...
            <div class="menu">
                ...
                <a href="changepassword.php" style="text-decoration-line: none; color: #ff3b49;">Cancelled Order</a><br><br>
            ...
            <div class="myForms">
                <!-- here -->
            <?php  
                  if($rowCount = mysqli_num_rows($queryCancelled)>0){
            while($results = mysqli_fetch_array($queryCancelled)) {?> 
                <div class="innerRow" style="border-left: 2px solid #ff3b49; padding: 0 10px; margin-bottom: 50px; background-color: rgba(255, 22, 22, 0.1); ">
                        <div class="form-row ">
                        ...
                        <div class="form-row ">
                            ...
                            <div class="form-group col-md-3">
                            <label for="inputPassword4" >Status: <strong class="text-danger"><?php echo $results['order_status'];?></strong></label>
                            </div>
                            <div class="form-group col-md-3">
