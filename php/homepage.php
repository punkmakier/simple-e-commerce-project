<?php
    ...
    F_userValidatePage();
    $rowCount = mysqli_num_rows($queryDisplay);
    ...
    {
        echo '<div class="modal fade" id="orderSuccess" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">

            <div class="modal-body mr-auto ml-auto mt-2 p-5" style="text-align: center;">
              HOORAY! Please wait for responds of the admin. You will receive a call or text message for verification of your order. <br> <br> Thank you for trusting <strong>Softy Business!</strong>
            </div>

              <button type="button" class="btn btn-success w-50  ml-auto mr-auto mb-5 mt-1" data-dismiss="modal">Confirm</button>
            ...
            <nav class="navbar navbar-expand-lg navbar-light cstm-nav">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <a class="btn dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                         <?php $viewuser->viewShoperName();?> <span class="badge badge-warning"><?php if($rowCount>0) {echo $rowCount;} ?></span>
                        </a>

                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item"  href="myaccount.php">My Account</a>
                            <a class="dropdown-item"   href="order.php">My order <span class="badge badge-warning"><?php if($rowCount>0) {echo $rowCount;} ?></span></a>
...
<div class="container-fluid-md pl-md-5 pr-md-5 pr-4 pl-4">
    <?php 
            $viewAnnounce = new viewAnnouncementUser();
            $viewAnnounce->viewAnnounceUser();
       ?>
    ...
    <div class="container mt-5">
        ...
        <div class="top-sales">
            ...
            <form action="searchUserProduct.php" class="form-inline my-2 my-lg-0 ml-0 cstm-search" method="get">
                <input name="searchProduct" class="form-control mr-sm-2"placeholder="Search" type="search" required>
                                ...
                                <strong style="text-shadow: 0 0 10px #000; position: absolute; left:0; z-index: 999; color: #fff; padding: 10px 10px; font-size: 15px; font-weight: 200; ">Stocks: <?php echo $results['product_stock'];?></strong>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <input name="product" type="hidden" value="<?php echo $results['id'];?>">
                                            ...
                                            <button name="ok" type="submit"class="btnCstm"><i class="fas fa-shopping-cart"></i> Order now</button> 
    ...
    <div class="container-fluid p-0" id="contact-aboutUs">
        ...
        <div class="content">
            ...
            <div class="contactAdmin">
                ...
                <div class="contactAdmin" style="margin-right: 40px;">
                    <h4>Service</h4>
                    <span>Deliver</span>
                    <span>Pick up</span>
                </div>
